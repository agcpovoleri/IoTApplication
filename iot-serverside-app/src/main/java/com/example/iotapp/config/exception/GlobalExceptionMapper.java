package com.example.iotapp.config.exception;

import com.example.iotapp.dto.GenericErrorResponse;
import com.example.iotapp.exception.BusinessValidationException;
